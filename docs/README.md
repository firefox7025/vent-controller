...
`run-wokwi.sh`. If no project id is specified, a DevKit for esp32s3 will be
used.
> **Warning**
>
...
- Terminal approach:
    ```
    $HOME/.espressif/tools/xtensa-esp32s3-elf/esp-2021r2-patch3-8.4.0/xtensa-esp32s3-elf/bin/xtensa-esp32s3-elf-gdb target/xtensa-esp32s3-espidf/debug/temp -ex "target remote localhost:9333"
    ```
